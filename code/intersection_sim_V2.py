...
TIME_STEP = 0.5
ARRIVAL_TIME = 10
HUMAN_CLEAR_TIME = 3.5
SDC_CLEAR_TIME = 2
HUMAN_TURNING_TIME = 5.5
SDC_TURNING_TIME = 4
HUMAN_MIN_STOP_TIME = 2.5
SDC_MIN_STOP_TIME = 1


NORTH_CAR_PROBABILITY = 0.1
EAST_CAR_PROBABILITY = 0.1
SOUTH_CAR_PROBABILITY = 0.1
WEST_CAR_PROBABILITY = 0.1


TURN_PROBABILITY = 0.1
LEFT_TURN_PROBABILITY = 0.33
